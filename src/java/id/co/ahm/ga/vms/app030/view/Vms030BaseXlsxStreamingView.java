 ...
 */
package id.co.ahm.ga.vms.app030.view;
 ...
 */
public abstract class Vms030BaseXlsxStreamingView extends AbstractXlsxStreamingView {
    ...
    protected void createCell(Row row, Object obj, int col, CellStyle cellStyle) {
        ...
        if (obj instanceof Date) {
            cell.setCellStyle(cellStyle);
            cell.setCellValue(Vms030DateTimeUtil.dateToString(((Date) obj)));
        }
