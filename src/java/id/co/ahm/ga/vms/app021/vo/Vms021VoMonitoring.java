 ...
 * @author ayik.op
 */
public class Vms021VoMonitoring {
    ...
    private List<Vms021VoLov> plants;
    private List<Vms021VoLov> gates;
    private List<Vms021VoLovNrp> nrps;
    private List<Vms021VoFileAttachment> fileVaccines;
    private List<Vms021VoFileAttachment> fileSk;
    ...
    public List<Vms021VoLov> getPlants() {
        return plants;
    }

    public void setPlants(List<Vms021VoLov> plants) {
        this.plants = plants;
    }

    public List<Vms021VoLov> getGates() {
        return gates;
    }

    public void setGates(List<Vms021VoLov> gates) {
        this.gates = gates;
    }

    public List<Vms021VoLovNrp> getNrps() {
        return nrps;
    }

    public void setNrps(List<Vms021VoLovNrp> nrps) {
        this.nrps = nrps;
    }

    public List<Vms021VoFileAttachment> getFileVaccines() {
        return fileVaccines;
    }

    public void setFileVaccines(List<Vms021VoFileAttachment> fileVaccines) {
        this.fileVaccines = fileVaccines;
    }

    public List<Vms021VoFileAttachment> getFileSk() {
        return fileSk;
    }

    public void setFileSk(List<Vms021VoFileAttachment> fileSk) {
        this.fileSk = fileSk;
    }
