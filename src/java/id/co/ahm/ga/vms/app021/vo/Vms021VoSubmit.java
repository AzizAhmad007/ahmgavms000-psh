...
public class Vms021VoSubmit {
    ...
    private List<Vms021VoLov> listPlants;
    private List<String> listPlantDelete;
    private List<Vms021VoLov> listGate;
    ...
    private List<Vms021VoMonitoring> listInactiveData;
    ...
    public List<Vms021VoLov> getListPlants() {
        return listPlants;
    }

    public void setListPlants(List<Vms021VoLov> listPlants) {
        this.listPlants = listPlants;
    }

    public List<Vms021VoLov> getListGate() {
        return listGate;
    }

    public void setListGate(List<Vms021VoLov> listGate) {
    ...
    public List<Vms021VoMonitoring> getListInactiveData() {
        return listInactiveData;
    }

    public void setListInactiveData(List<Vms021VoMonitoring> listInactiveData) {
