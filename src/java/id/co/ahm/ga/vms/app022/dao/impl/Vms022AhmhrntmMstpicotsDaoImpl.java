...
public class Vms022AhmhrntmMstpicotsDaoImpl extends HrHibernateDao<AhmhrntmMstpicots, String> implements Vms022AhmhrntmMstpicotsDao{
    ...
    public int countLovNrp(DtoParamPaging input) {
        ...
        sql = Vms022QueryUtil.setSearchParamLov(sql, input.getSearch(), "A.VNRP,B.NAME", "PLANT");
    ...
    public List<Vms022VoLov> lovNrp(DtoParamPaging input) {
        ...
        sql = Vms022QueryUtil.setSearchParamLov(sql, input.getSearch(), "A.VNRP,B.NAME", "PLANT");
        sql = Vms022QueryUtil.setSortParamLov(sql, input, "id,name", "PLANT");
    ...
    public List<Vms022VoLovNrp> getPicAhm(String outType, List<String> plants) {
        ...
        List<Vms022VoLovNrp> results = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < lists.size(); i++) {
                ...
                Vms022VoLovNrp vo = new Vms022VoLovNrp();
