 ...
 */
package id.co.ahm.ga.vms.app026.view;
 ...
 * @author fsant
 */
public abstract class Vms026BaseXlsxStreamingView extends AbstractXlsxStreamingView {
    @Override
    ...
    protected void createCell(Row row, Object obj, int col, CellStyle cellStyle) {
        ...
        if (obj instanceof Date) {
            cell.setCellStyle(cellStyle);
            cell.setCellValue(Vms022DateTimeUtil.dateToString(((Date) obj)));
        }
